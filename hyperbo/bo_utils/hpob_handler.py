    ...
    def __init__(self, root_dir = "hpob-data/", mode = "v3-test", surrogates_dir="saved-surrogates/"):
        ...
        Inputs:
            ...
            * mode: mode name indicating how to load the data. Options: 
                ...
                - v2: Loads hpob-v2
                - v3: Loads hpob-v3
                - v3-test: Loads only the meta-test split from hpob-v3
                - v3-train-augmented: Loads all splits from hpob-v3, but augmenting the meta-train data with the less frequent search-spaces.
            * surrogates_dir: path to directory with surrogates models.

        """
        
        print("Loading hpob handler")
        self.mode = mode
